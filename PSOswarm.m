...
ylabel('North (m)');
zlabel('Up (m)');
title('PSO-based UAV Search Progress');
view(45, 30);
...
%% PSO Search
fprintf('Initial ascent complete. Starting PSO search...\n');
...
for iter = 1:max_iterations
    ...
    for i = 1:num_drones
        ...
        if is_safe
            ...
            velocities(i,1:2) = max_speed * (2 * rand(1, 2) - 1);
            velocities(i,3) = 0;  % Maintain height
        end
    end
